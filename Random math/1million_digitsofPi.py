...
# This code is not mine. It is copied directly from Don Cross' medium article:
# https://medium.com/@cosinekitty/how-to-calculate-a-million-digits-of-pi-d62ce3db8f58
# I only used it to generate the digits of pi into the file pi_1million_digits.txt
